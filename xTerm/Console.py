...
from . import Errors as error, Themes as themes
...
class ConsoleOptions:
    """Options for __xTerm_Console__ method."""
...
"""A string or any object that may be rendered by xTerm."""

# The result of calling a __xTerm_Console__ method.
...
class Console:
    ...
    def set_window_title(self, title: str) -> bool:
        ...
        Warning: There is no means within xTerm of "resetting" the window title to its
    ...
    def render(
        ...
        if hasattr(renderable, "__xTerm_Console__") and not isclass(renderable):
            render_iterable = renderable.__xTerm_Console__(self, _options)  # type: ignore[union-attr]
        elif isinstance(renderable, str):
            text_renderable = self.render_str(
                renderable, highlight=_options.highlight, markup=_options.markup
            )
            render_iterable = text_renderable.__xTerm_Console__(self, _options)
        else:
            raise errors.NotRenderableError(
                f"Unable to render {renderable!r}; "
                "A str, Segment or object with __xTerm_Console__ method is required"
            )
    ...
    def _collect_renderables(
        ...
        *,
        ...
        Args:
            objects (Iterable[Any]): Anything that xTerm can render.
    ...
    def update_screen(
        ...
        *,
        ...
        Args:
            renderable (RenderableType): A xTerm renderable.
    ...
    def print_exception(
        ...
        *,
        ...
        """Prints a xTerm render of the last exception and traceback.
    ...
    def log(
        ...
        *objects: Any,
        ...
        """Log xTerm content to the terminal.
    ...
    def export_svg(
        ...
        *,
        ...
        Args:
            ...
            clear (bool, optional): Clear record buffer after exporting. Defaults to ``True``
            code_format (str, optional): Format string used to generate the SVG. xTerm will inject a number of variables
                into the string in order to form the final SVG output. The default template used and the variables
                injected by xTerm can be found by inspecting the ``console.CONSOLE_SVG_FORMAT`` variable.
