...
def _ipy_display_hook(
    ...
    # always skip xTerm generated jupyter renderables or None values
...
def install(
    ...
    def display_hook(value: Any) -> None:
        """Replacement sys.displayhook which prettifies objects with xTerm."""
    ...
    try:
        ...
        # replace plain text formatter with xTerm formatter
        rich_formatter = RichFormatter()
        ip.display_formatter.formatters["text/plain"] = rich_formatter


class Pretty(JupyterMixin):
    """A xTerm renderable that pretty prints an object.
